...
self:   prep
	...
	mkdir -p src/github.com/aaronland/go-artisanal-integers-proxy-boltdb
	# cp *.go src/github.com/aaronland/go-artisanal-integers-proxy-boltdb/
	cp -r vendor/* src/
...
deps:
	...
	@GOPATH=$(shell pwd) go get "github.com/whosonfirst/go-whosonfirst-pool-boltdb"
